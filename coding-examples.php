            ...
            <div id="coding-examples" class="coding-examples">
                ...
                <div class="row">
                    <div class="col-12 col-xl-6">
                        <div class="card">
                            <h2>Back-end validation with PHP</h2>
                            <pre>
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="card">
                            ...
                            <h2>Front-end validation with Javascript</h2>
                            <pre>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="card">                
                            <h2>Eloquent Query with Elastic Search</h2>
                            <pre>
                                <code class="language-php">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="card">               
                            <h2>Simple Laravel Scope Filter</h2>                
                            <pre class="short-pre">
